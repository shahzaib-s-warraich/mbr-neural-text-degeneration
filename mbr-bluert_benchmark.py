...
# ----------------------- Greedy Text Generation MBR (eta (local typical and epsilon), epsilon, top-p, top-k) BLEURT benchmark ---------------------------
...
mbr_config = MBRConfig(num_samples=10, num_references=10, metric=metric, metric_output_field="bleurt")
